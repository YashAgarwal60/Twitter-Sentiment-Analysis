...
def fun2(scr,dt,ct):
    ...
    try:
        ...
        tweets = extractor.user_timeline(screen_name=str(dt), count = ct)
    except:
...
def page_two(scr1):
    ...
    lab=Label(mainf2,text= "Created by ",fg="red",font=('Times New Roman',20,'bold'),bg='sky blue')
...
def page_three(scr1):
    ...
    c=Canvas(mainf2,height=618,width=1366)
    c.pack()
    lab=Label(mainf2,text='Name',font=('Times New Roman',18,'bold'))
    lab.place(x=10,y=60)
    ent=Entry(mainf2,width=20,bd=2,textvariable=var,font=('Times New Roman',18,'bold'))
    ent.place(x=100,y=60)
    lab=Label(mainf2,text='Count',font=('Times New Roman',18,'bold'))
    lab.place(x=400,y=60)
    ent1=Entry(mainf2,width=15,bd=2,font=('Times New Roman',18,'bold'))
    ent1.place(x=500,y=60)
    ent1.insert(0,200)
    b=Button(mainf2,command=lambda :fun2(scr,str(var.get()),int(ent1.get())),height=2,width=10,text='Go',font=('Times New Roman',12,'bold'),bg='green',fg='white')
    b.place(x=300,y=100)
    backs=PhotoImage(file="abc.gif")
    c.create_image(350,172,image=backs)
    lab=Label(mainf2,text= "Created by ",fg="red",font=('Times New Roman',20,'bold'),bg='sky blue')
...
def live():
    ...
    l=Label(f,text='Tweets',font=('Times New Roman',12,'bold'))
    l.grid(row=0,column=0)
    l1=Label(f,text='Sentiment',font=('Times New Roman',12,'bold'))
    l1.grid(row=0,column=1)
    m=Message(f,font=('Times New Roman',12,'bold'))
    m.grid(row=1,column=0)
    l2=Label(f,font=('Times New Roman',12,'bold'))
    l2.grid(row=1,column=1)
    b=Button(f,text='Next',font=('Times New Roman',12,'bold'),command=lambda :mydata(m,l2))
